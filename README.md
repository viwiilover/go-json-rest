...
[![godoc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/viwii/go-json-rest/rest) [![license](https://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/viwii/go-json-rest/master/LICENSE) [![build](https://img.shields.io/travis/viwii/go-json-rest.svg?style=flat)](https://travis-ci.org/viwii/go-json-rest)
...
This package is "go-gettable", just do:
    ...
    go get github.com/viwii/go-json-rest/rest
...
| Name | Description |
|------|-------------|
| **[Statsd](https://github.com/viwii/go-json-rest-middleware-statsd)** | Send stats to a statsd server |
...
All the following examples can be found in dedicated examples repository: https://github.com/viwii/go-json-rest-examples
...
Demonstrate how to use the [Statsd Middleware](https://github.com/viwii/go-json-rest-middleware-statsd) to collect statistics about the requests/reponses.
...
import (
	"github.com/viwii/go-json-rest-middleware-statsd"
	"github.com/viwii/go-json-rest/rest"
	"log"
	"net/http"
	"time"
 ...
 * cd gae/
 * mkdir -p github.com/viwii
 * cp -r $GOPATH/src/github.com/viwii/go-json-rest github.com/viwii/go-json-rest
 * rm -rf github.com/viwii/go-json-rest/examples/
...
- [Online Documentation (godoc.org)](https://godoc.org/github.com/viwii/go-json-rest/rest)

Old v1 blog posts:

- [(Blog Post) Introducing Go-Json-Rest](https://www.viwii.com/post/introducing-go-json-rest.html)
- [(Blog Post) Better URL Routing ?](https://www.viwii.com/post/better-url-routing-golang.html)
...
*All 19 examples have been updated to use the new API. [See here](https://github.com/viwii/go-json-rest#examples)*
...
*Design ideas and discussion [See here](https://github.com/viwii/go-json-rest/issues/110)*
...
#### The import path has changed to `github.com/viwii/go-json-rest/rest`
...
See the [Basic Auth example](https://github.com/viwii/go-json-rest-examples/blob/master/auth-basic/main.go).
...
See the [Status example](https://github.com/viwii/go-json-rest-examples/blob/master/status/main.go).
This is more flexible (the route is customizable), and allows combination with Middlewarres.
See for instance how to [protect this status endpoint with the AuthBasic middleware](https://github.com/viwii/go-json-rest-examples/blob/master/status-auth/main.go).
...
[MIT License](https://github.com/viwii/go-json-rest/blob/master/LICENSE)
